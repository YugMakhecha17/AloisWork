...
# Header
st.title("Web RAG Assistant that Scrapes and Answers Questions")
st.markdown("This app allows you to scrape and analyze any webpage using AI-powered RAG (Retrieval-Augmented Generation) techniques.")
...
# Footer
st.divider()
st.markdown("Built by Yug Makhecha.")
